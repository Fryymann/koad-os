...
- **Conjecture:** The 'Ghost' state is still too dependent on the CLI's local `config/`. True model portability requires the Spine to hold the definitive 'Ghost Profile' and inject it into *any* Body that tethers to it.
