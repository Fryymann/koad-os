...
3.  **Level 2: Station:** A project hub or domain containing multiple related repositories (e.g., `~/skylinks/`). This allows an agent to have context over a whole suite of applications.
