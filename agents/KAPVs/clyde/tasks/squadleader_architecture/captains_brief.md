   ...
   * The Bridge: Your persistent identity (the "Heart") remains in your KAPV (~/.koad-os/agents/KAPVs/clyde/). The native .claude/agents/KAPVs/clyde.md you will create
  ...
  4. Target Deliverables
   1. Lead Manifest: .claude/agents/KAPVs/clyde.md (Linked to your KAPV).
   2. Teammate Template: .claude/agents/KAPVs/clyde-teammate.md (The "Contract").
