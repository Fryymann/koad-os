...
- **Sanctuary:** `agents/KAPVs/clyde/` (Vault)
- **Runtime:** claude
- **Tier:** 3 (Officer)
...
- **Sanctuary Rule:** Write authority is scoped to `agents/KAPVs/clyde/` by default.
...
- **Vault write:** `~/.koad-os/agents/KAPVs/clyde/` (unrestricted within sanctuary)
