...
def test_admin_sandbox_execution(spine, redis_client):
    ...
    # Run a simple echo command through the v3 CLI
    result = spine.run_cli(["run", "echo 'sandbox_pass'"])
    assert result.returncode == 0
    # The current mock Kernel implementation returns this success string
