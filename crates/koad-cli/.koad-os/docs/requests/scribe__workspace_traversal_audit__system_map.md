...
1. KoadOS System Map — the canonical index/manifest of folder structures, key file locations, and navigation hints that all agents will use for orientation
