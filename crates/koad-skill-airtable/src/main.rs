...
use koad_proto::skill::{RunRequest, RunUpdate, StatusUpdate, Empty};
...
impl SkillService for AirtableSkill {
    ...
    async fn report_status(&self, _request: Request<StatusUpdate>) -> Result<Response<Empty>, Status> {
