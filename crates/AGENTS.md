...
| `koad-sandbox` | Phase 4 | Config-driven security jailing; containerized execution active. |
| `koad-plugins` | Phase 4 | WASM plugin runtime (wasmtime); dynamic loading active. |

## Ⅱ. Engineering Guidelines

- **Standard:** Follow [RUST_CANON.md](../docs/protocols/RUST_CANON.md) for all logic and I/O.
- **Purity:** No legacy Spine code or terminology allowed.
