...
impl Admin for AdminService {
    ...
    async fn shutdown(&self, request: Request<ShutdownRequest>) -> Result<Response<StatusResponse>, Status> {
    ...
    async fn get_system_status(&self, request: Request<SystemStatusRequest>) -> Result<Response<SystemStatusResponse>, Status> {
        let req = request.into_inner();
    ...
    async fn force_purge_session(&self, request: Request<PurgeRequest>) -> Result<Response<StatusResponse>, Status> {
        let req = request.into_inner();
